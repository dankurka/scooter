//////////////////////////////////////////////////////////////////
//
//   $Header: /cvs/Controller\040Board/AVR-Code/Testsuite/globals.h,v 1.12 2007/09/12 04:17:02 rainer Exp $
...
/** Size of the Buffer holding the battery voltage values */
#define BAT_SAMPLES_BUFSIZE 16
...
/* *********   Battery voltage ******** */
uint16_t battery_samples[ BAT_SAMPLES_BUFSIZE ];
uint8_t battery_idx;

uint16_t steering_zero_point;

/** ADC-Value of the battery */
uint16_t battery_adc_val;
